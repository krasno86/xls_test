...
def save_districts_to_db(district_hash)
  ...
  begin
    client.query("INSERT INTO oleg_krasno_florida_edu_course_enroll_by_course_s3_1617 (
                                    course_number,
                                    course_name,
                                    enrollment,
                                    data_source_url,
                                    ...
                                    ll_scrape_dev_name,
                                    academic_year)
          VALUES (#{district_hash[:course_number]},
                  #{district_hash[:course_name]},
                  #{district_hash[:enrollment]},
